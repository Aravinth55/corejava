package com.chainsys.reflextion;
...
public class ListClassMembers {
	...
	public static void testB() {
		String classname = "com.chainsys.reflextion.Actor";
...
public static void testsetAccessible() {
		try {
			String cname = "com.chainsys.reflextion.Actor";
...
// city is default access modifier
			...
			fieldCity.set(objReference, "Dindigul");
